...
attr(master$petition, "label") <- "Sign petition"
attr(master$boycott, "label") <- "Boycott certain products"
attr(master$demo, "label") <- "Take part in a demonstration"
attr(master$meeting, "label") <- "Attend political meeting or rally"
attr(master$contpol, "label") <- "Contact a politician"
attr(master$donate, "label") <- "Donate money or raise funds"
attr(master$contmed, "label") <- "Contact media"
attr(master$expint, "label") <- "Express views on the internet"
